...
### 3)-Data augmentation for improving the model
...
### 4)-Using a pre-trained model i.e VGG16 + small MLP
...
### 5)-Fine-tuning the top layers of a a pre-trained network
...
#Load for evaluation purpose again
